...
class Event(metaclass=ABCMeta):
    ...
    def get_event_name(self) -> str:
        ...
        if self.sub_type is None:
            return "%s_%s" % (self.post_type, self.event_sub_type())
        else:
            return "%s_%s_%s" % (self.post_type, self.event_sub_type(), self.sub_type)
...
class Message_Event(Event):
    ...
    def get_message(self, cqapi: 'cqHttpApi') -> Message:
